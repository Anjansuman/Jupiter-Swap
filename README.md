...
npx create-solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-Jupiter-Swap
# created an pnpm based project
pnpx create-solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-Jupiter-Swap
# created an yarn based project
yarn create solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-Jupiter-Swap
```
...
cd solana-templates/legacy-Jupiter-Swap
```
